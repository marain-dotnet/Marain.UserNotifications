...
Feature: Batch update of notification delivery statuses via the client library
...
Scenario: Set delivery state of a subset of notifications for a user
	...
	When I use the client to send a management API request to batch update the delivery status of the first 10 stored notifications for user 'user100' to 'Delivered' for the delivery channel with Id 'api'
