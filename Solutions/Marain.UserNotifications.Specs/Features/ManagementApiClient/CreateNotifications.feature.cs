...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/ManagementApiClient", "Create Notifications via the client library", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        public void CreateNotifications(string notes, string notificationType, string userIds, string timestamp, string propertiesJson, string correlationIds, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create notifications", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
