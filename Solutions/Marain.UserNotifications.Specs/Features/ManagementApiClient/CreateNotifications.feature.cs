...
#line hidden
        ...
        public virtual void CreateNotifications(string notes, string notificationType, string userIds, string timestamp, string propertiesJson, string correlationIds, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create notifications", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
