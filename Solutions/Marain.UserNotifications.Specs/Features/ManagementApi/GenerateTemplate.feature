...
Scenario: Generate populated template
	Given I have created and stored an email notification template
		...
		| A new lead was added by {{leadAddedBy}} | A new lead added: {{leadAddedBy}} | application/vnd.marain.usernotifications.notificationtemplate.emailtemplate.v1 | Base+64xddfa | marain.NewLeadv1 |
...
Scenario: Generate populated template having nested objects in the property bag
	Given I have created and stored a web push notification template
		| body                                    | title                             | contentType                                                                      | actionUrl                 | image        | notificationType |
		| A new lead was added by {{leadAddedBy}} | A new lead added: {{leadAddedBy}} | application/vnd.marain.usernotifications.notificationtemplate.webpushtemplate.v1 | https://www.google.co.uk/ | Base+64xddfa | marain.NewLeadv2 |
	When I send the generate template API request
		"""
        {
