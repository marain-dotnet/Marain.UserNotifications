...
#line hidden
            ...
            else
            {
                ...
                table36.AddRow(new string[] {
                            ...
                            "{\"notificationType1\": [\"email\", \"sms\"]}"});
#line 34
 testRunner.Given("I have created and stored a user preference for a user", ((string)(null)), table36, "Given ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table38.AddRow(new string[] {
                            ...
                            "{\"notificationType1\": [\"email\", \"sms\"]}"});
#line 48
 testRunner.Given("I have created and stored a user preference for a user", ((string)(null)), table38, "Given ");
#line hidden
...
#line 51
 testRunner.When("I send a user preference API request to update a previously saved user preference" +
                        " that has an invalid etag in the request body", ((string)(null)), table39, "When ");
#line hidden
#line 54
...
#line hidden
            ...
            else
            {
                ...
                table40.AddRow(new string[] {
                            ...
                            "{\"notificationType1\": [\"email\", \"sms\"]}"});
#line 57
 testRunner.Given("I have created and stored a user preference for a user", ((string)(null)), table40, "Given ");
#line hidden
...
#line 60
 testRunner.When("I send a user preference API request to update a previously saved user preference" +
                        " that has no etag in the request body", ((string)(null)), table41, "When ");
#line hidden
#line 63
