...
#line hidden
        ...
        public virtual void SetDeliveryStateOfASubsetOfNotificationsForAUser()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Set delivery state of a subset of notifications for a user", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line hidden
        ...
        public virtual void UpdateDeliveryStateOfASubsetOfNotificationsForAUser()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update delivery state of a subset of notifications for a user", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 20
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
