...
namespace Marain.UserNotifications.Management.Host.Activities
{
    ...
    public class CompleteLongRunningOperationActivity
    {
            ...
            [ActivityTrigger] IDurableActivityContext context)
        {
            ...
            {
                var exception = new Exception($"Unexpected arror when attempting to complete long running operation '{operationId}' for tenant '{delegatedTenantId}': {operationResult.Status} - {operationResult.Title}");
