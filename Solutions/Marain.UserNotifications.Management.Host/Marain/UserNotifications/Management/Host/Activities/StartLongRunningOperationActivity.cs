...
namespace Marain.UserNotifications.Management.Host.Activities
{
    ...
    public class StartLongRunningOperationActivity
    {
        ...
        public StartLongRunningOperationActivity(
            ...
            [ActivityTrigger] IDurableActivityContext context)
        {
            ...
            ProblemDetails operationResult = await this.operationsControl.SetOperationRunningAsync(delegatedTenantId, operationId);
